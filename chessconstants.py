...
# generally these are values that need to be known by more than one module
...
OC_INCHECK	= 0x003	# enemy in check

# "special" squares

SQ_EMPTY	= "."	# empty
SQ_OFFBOARD	= "*"	# off the board
SQ_STOP		= "x"	# piece placing stopped

# fen constants

FEN_NONE		= "-"	# unused / no value
